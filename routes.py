...
app.config['MAIL_SERVER']='smtp-mail.outlook.com' # Your mail server
app.config['MAIL_PORT'] = 587 # Your mail server port
app.config['MAIL_USERNAME'] = 'abhijithng.rv@outlook.com' # your mail server username
app.config['MAIL_PASSWORD'] = 'imustImprove0$' # your mail server password
...
def add_review_dashboard():
        return render_template("dashboard/html/reviews.html", user=current_user,  comments=models.Comment, app=app, reviews=models.Review)
